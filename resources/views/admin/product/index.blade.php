    ...
    <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">
                ...
                <a id="activeAllStatus" url="{{ route('product.statusActive')}}" class="btn btn-danger btn-xm"><i class="fa fa-eye"></i></a>
                <a id="deactiveAllStatus" url="{{ route('product.statusDeactive')}}" class="btn btn-danger btn-xm"><i class="fa fa-eye-slash"></i></a>
                <a id="deleteAll" url="{{ route('product.deleteAll')}}" class="btn btn-danger btn-xm"><i class="fa fa-trash"></i></a>
        ...
        <div class="box-body">
          ...
          <table class="table table-bordered">
            ...
            <tr>
              <td><input type="checkbox" name="statusAll[]" value="{{ $product->id }}" id="" class="checkSingle"></td>
              <td>{{ $product->title }}</td>
              
              
              <td>@if($product->product_img == 'No image found')
                <img src="/assets/admin/dist/img/no-img.png" width="100" height="100" class="img-thumbnail" alt="NO image found">
                @else
                <img src="/uploads/{{ $product->product_img}}" width="100" height="100" class="img-thumbnail" alt="{{ $product->title}}">
                @endif
              </td>
              <td>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <span style="display:block;font-size:15px;line-height:34px;margin:20px 0;">
                        Showing {{($products->currentpage()-1)*$products->perpage()+1}} to {{$products->currentpage()*$products->perpage()}} of {{$products->total()}} entries</span>
                </div>
