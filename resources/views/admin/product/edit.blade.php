...
<section class="content">
      ...
      <!-- SELECT2 EXAMPLE -->
      <!-- form start -->
      <form name="formEdit" id="formEdit" method="post" action="/admin/product/{{ $Product->id }}" enctype="multipart/form-data">
        @csrf
        @method('put')
            ...
            <input type="hidden" id="spec_count" name="spec_count" value="2">
                <div class="col-xs-6">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="sub_category_id" id="sub_category_id" style="width: 100%;">
                        ...
                        @foreach ($subcategories as $subcategory)
                            <option value="{{ $subcategory->id }}"{{ ($Product->sub_category_id == $subcategory->id ) ? 'selected' : null }}>{{ $subcategory->name }}</option>
                            @endforeach
                 ...
                 <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="rating" id="rating" placeholder="rating" value="{{ $Product->rating }}">
                 </div>
                  <div class="form-group">
                    <label for="publisher">Publisher</label>
                    <input type="text" class="form-control" name="publisher" id="publisher" placeholder="Publisher" value="{{ $Product->publisher }}">
                  </div>
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="country_of_publisher" id="country_of_publisher" style="width: 100%;">
                      ...
                      @foreach($countries as $country)
                        <option value="{{ $country->name }}" {{ ($Product->country_of_publisher == $country->id ) ? 'selected' : null }}>{{ $country->name }}</option>
                        @endforeach
                    </select>
                  </div>
                  <div class="form-group">
                    <label for="isbn">ISBN</label>
                    <input type="text" class="form-control" name="isbn" id="isbn" placeholder="ISBN" value="{{ $Product->isbn }}">
                  </div>

                    <div class="form-group">
                      <label for="isbn_10">ISBN-10</label>
                      <input type="text" class="form-control" name="isbn_10" id="isbn_10" placeholder="ISBN-10" value="{{ $Product->isbn_10 }}">
                    </div>
                </div>
                ...
                <div class="col-xs-6">
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="audience" id="audience" placeholder="Audience" value="{{ $Product->audience }}">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="recommended" id="recommended" style="width: 100%;" >
                        ...
                        <option value="yes" {{ ($Product->recommended == 'yes') ? 'selected' : null }}>Recomended</option>
                        <option value="no" {{ ($Product->recommended == 'no') ? 'selected' : null }}>Not Recomended</option>
                      </select>
                    </div>
                    <div class="form-group">
                      <label for="product_img">product Image</label>
                      <input type="file" class="form-control" name="product_img" id="product_img" value="{{ $Product->product_img }}">
                    ...
                    <div id="TextBoxDiv1 col-md-12">
                      ...
                      <div class="col-md-6">
                      <label>Title : </label><input type='textbox' name="spec_title1" id='spec_title1' class="form-control" value="{{ $spec->title }}" >
                      </div>
                      
                      <div class="col-md-6" >
                      <label>Description : </label><input type='textbox' name="spec_desc1" id='spec_desc1' class="form-control" value="{{ $spec->description }}"  >
                      </div>
                      @endforeach
                    </div>
                  </div>
